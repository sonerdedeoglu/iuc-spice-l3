...
SRC_FORM_DIR = ROOT / "confluence/pages/000-root-iuc-bidb-spice-2026-level-3/01-surec-dokumanlari/src-001-dokumantasyon-sureci/frm-001-surec-gozden-gecirme-formu-src-001"
...
TARGET_SLUG = "frm-001-surec-gozden-gecirme-formu-src-001-degerlendirme-1"
TARGET_TITLE = "FRM.001 - Süreç Gözden Geçirme Formu (SRÇ.001) - Değerlendirme #1"
...
EVAL: dict[str, dict[str, Any]] = {
    "SUP.7.BP1": {"pct": 85, "evidence": ["SRÇ.001", "PRS.001", "LST.005.Ş", "Soru Bankası Projesi / LST.005 (SB)"], "note": "Standart; neyin, hangi organizasyonel yapı içinde ve ürün/hizmet yaşam döngüsünün hangi aşamalarında dokümante edileceğini kapsayan bir strateji ister. SRÇ.001 kurumsal yaklaşımı, PRS.001 yazılım projesi stratejisini, LST.005.Ş ise yaşam döngüsü doküman üretimini tanımlar. SB kaydı henüz taslak olsa da strateji seviyesi büyük ölçüde karşılanmaktadır.", "action": "-"},
    "SUP.7.BP2": {"pct": 90, "evidence": ["KLV.001", "SRÇ.XXX.Ş", "PRS.XXX.Ş", "KLV.XXX.Ş", "LST şablon ailesi"], "note": "Standart, dokümanların geliştirilmesi, değiştirilmesi ve sürdürülmesi için standartlar kurulmasını ister. KLV.001 ile yazım/sürüm kuralları; güncel şablon ailesi ile yapı ve içerik standartları tanımlanmıştır.", "action": "-"},
    "SUP.7.BP3": {"pct": 85, "evidence": ["KLV.001", "SRÇ/PRS/KLV/LST şablonları", "LST.001", "Doküman sürüm geçmişleri"], "note": "Standart; format, başlık, tarih, tanımlayıcı, sürüm geçmişi, hazırlayan, gözden geçiren, onaylayan, içerik ana hatları, amaç ve dağıtım bilgilerini ister. Bu alanların büyük bölümü şablonlarda ve KLV.001'de bulunur. Dağıtım hedef kitlesi bilgisi her dokümanda aynı açıklıkta değildir.", "action": "-"},
    "SUP.7.BP4": {"pct": 80, "evidence": ["LST.001", "LST.005.Ş", "Soru Bankası Projesi / LST.005 (SB)", "SRÇ.001 alt kayıtları"], "note": "Standart, belirli bir yaşam döngüsü geliştirmesinde üretilecek dokümanların belirlenmesini ister. Genel doküman envanteri ve yaşam döngüsü matrisi vardır; proje özel matrisin gerçek kanıtlarla tamamlanması gerekmektedir.", "action": "-"},
    "SUP.7.BP5": {"pct": 85, "evidence": ["SRÇ.001", "PRS.001", "KLV.001", "LST.001", "SRÇ.001 altındaki LST.007/LST.008/LST.009/LST.010", "Confluence ve Git geçmişi"], "note": "Standart, dokümanların gerekli süreç noktalarında belirlenmiş standart ve politikalara göre geliştirilmesini ister. SRÇ.001 doküman seti üretilmiştir; proje yaşam döngüsü boyunca üretimin sürekliliği SB örneğinde henüz tam kanıtlanmamıştır.", "action": "-"},
    "SUP.7.BP6": {"pct": 55, "evidence": ["SRÇ.001 altındaki özelleştirilmiş FRM.001", "LST.003.Ş", "Doküman sürüm geçmişleri", "Confluence revizyon geçmişi"], "note": "Standart, dağıtım öncesi gözden geçirme ve yayın öncesi yetkilendirme ister; ayrıca doğrulama/validasyon ve paydaş katılımını not eder. Form ve onay yapısı vardır fakat son revizyonlar için sistematik gerçek LST.003 kayıtları ve bağımsız doğrulama/paydaş kanıtları yetersizdir.", "action": "SRÇ.001, PRS.001, KLV.001, LST.001 ve LST.007 için gerçek gözden geçirme/onay kayıtları LST.003 içinde tamamlanmalı; gerekli paydaş doğrulaması ilişkilendirilmelidir."},
    "SUP.7.BP7": {"pct": 55, "evidence": ["Confluence sayfa ağacı", "LST.001", "PRS.001", "Publish raporları"], "note": "Standart, belirlenmiş dağıtım yöntemleri ve medya üzerinden belirli hedef kitlelere dağıtımı ve gerektiğinde teslim teyidini ister. Confluence fiili yayın ortamıdır; ancak hedef kitle, duyuru/teslim ve gerektiğinde alındı teyidi kayıtları sistematik değildir.", "action": "Doküman türü bazında hedef kitle ve dağıtım yöntemi netleştirilmeli; kritik yayınlar için LST.012 veya eşdeğer iletişim/teslim kayıtları tutulmalıdır."},
    "SUP.7.BP8": {"pct": 60, "evidence": ["LST.002", "Doküman sürüm geçmişleri", "Arşiv - Kaldırılan Şablonlar", "Git commit geçmişi", "SRÇ.016"], "note": "Standart, dokümanların belirlenmiş stratejiye göre sürdürülmesini; kontrollü/baseline dokümanlarda SUP.8 ile bağlantıyı ister. Sürümleme ve arşiv vardır fakat LST.002 güncelliği ve formal yapılandırma/baseline bağlantısı tam değildir.", "action": "Son doküman ve şablon revizyonları LST.002'ye işlenmeli; kontrollü dokümanların SRÇ.016 kapsamındaki değişiklik/baseline kurallarıyla bağı açıklaştırılmalıdır."},

    "GP.2.1.1": {"pct": 75, "evidence": ["LST.009 (SRÇ.001)", "SRÇ.001"], "note": "Standart; kalite, çevrim/frekans, kaynak kullanımı ve süreç sınırları gibi performans amaçlarını; kapsam, varsayım ve kısıtları ister. LST.009 üç temel ölçüm hedefi tanımlar. Kaynak kullanımı ile varsayım/kısıt boyutu sınırlı kalmıştır.", "action": "-"},
    "GP.2.1.2": {"pct": 55, "evidence": ["SRÇ.001 faaliyetleri", "LST.009", "FRM.001 değerlendirme yapısı"], "note": "Standart; performans planı, çevrim, kilometre taşları, tahminler, görevler, takvim, iş ürünü gözden geçirmeleri ve fiili izlemeyi birlikte ister. Faaliyetler ve ölçüm seti tanımlıdır; periyotlu uygulama planı, kilometre taşı ve gerçekleşen ölçüm kayıtları yetersizdir.", "action": "Süreç performans çevrimi, ölçüm periyodu, sorumlular, kilometre taşları ve gerçekleşen ölçüm sonuçları kayıt altına alınmalıdır."},
    ...
    "GP.2.1.4": {"pct": 80, "evidence": ["LST.010 (SRÇ.001)", "SRÇ.001 roller bölümü"], "note": "Standart; yürütme ve doğrulama sorumlulukları/yetkileri ile gerekli deneyim, bilgi ve becerilerin tanımlanmasını ister. RACI ve yetkiler güçlüdür; yetkinlik beklentileri daha sınırlı ayrıntıdadır.", "action": "-"},
    "GP.2.1.5": {"pct": 60, "evidence": ["Confluence/repository altyapısı", "KLV.004", "LST.011", "PRS.001"], "note": "Standart, insan ve altyapı kaynaklarının ve gerekli bilginin belirlenmesini, tahsis edilmesini ve kullanılmasını ister. Araçlar ve bilgi alanları mevcuttur; insan kaynağı tahsisi ve kullanım kayıtları formal değildir.", "action": "SRÇ.001 için gerekli insan kaynağı, zaman, araç ve bilgi kaynakları ile bunların tahsis/kullanım durumu kayıt altına alınmalıdır."},
    "GP.2.1.6": {"pct": 65, "evidence": ["LST.007 (SRÇ.001)", "LST.010 (SRÇ.001)", "LST.012.Ş"], "note": "Standart, ilgili tarafların belirlenmesini, sorumlulukların atanmasını, arayüzlerin yönetilmesini ve etkili iletişimi ister. Etkileşim ve RACI tanımlıdır; iletişimin fiilen yürütüldüğünü gösteren yaygınlaştırma/iletişim kayıtları sınırlıdır.", "action": "İlgili taraf iletişimleri ve süreç yaygınlaştırma faaliyetleri LST.012 veya eşdeğer kayıtla kanıtlanmalıdır."},

    "GP.2.2.1": {"pct": 85, "evidence": ["LST.008 (SRÇ.001)", "Şablon ailesi", "KLV.001"], "note": "Standart; iş ürünü içerik/yapı gereksinimleri, kalite kriterleri ve gözden geçirme/onay kriterlerini ister. LST.008 ve şablonlar bu beklentiyi büyük ölçüde karşılar.", "action": "-"},
    "GP.2.2.2": {"pct": 75, "evidence": ["KLV.001", "PRS.001", "LST.001", "LST.007"], "note": "Standart; dağıtım, tanımlama, bileşenler, izlenebilirlik/bağımlılıklar ve onay gereksinimlerini ister. Doküman kontrol kuralları ve etkileşimler vardır; bağımlılıkların tüm iş ürünlerinde tekil izlenebilirliği sınırlıdır.", "action": "-"},
    "GP.2.2.3": {"pct": 60, "evidence": ["LST.001", "Doküman sürüm geçmişleri", "Confluence erişim yapısı", "Git geçmişi", "LST.002"], "note": "Standart; kontrollü iş ürünlerinin belirlenmesi, değişiklik kontrolü, sürüm/configuration ilişkisi, erişim ve revizyon durumunun görülebilmesini ister. Tanımlama, sürüm ve erişim vardır; değişiklik kontrolü ve configuration/baseline ilişkisi tam değildir.", "action": "Kontrollü doküman kapsamı, değişiklik akışı, sürüm/baseline ilişkisi ve güncel revizyon durumu LST.002 ve SRÇ.016 ile tutarlı hale getirilmelidir."},
    "GP.2.2.4": {"pct": 50, "evidence": ["SRÇ.001 altındaki FRM.001", "LST.003.Ş", "Confluence revizyon geçmişi"], "note": "Standart, iş ürünlerinin planlı düzenlemelere göre gereksinimlere karşı gözden geçirilmesini ve bulguların çözülmesini ister. Gözden geçirme yapısı vardır; planlı inceleme, bulgu ve kapanış kayıtları yeterince sistematik değildir.", "action": "İş ürünü bazında planlı gözden geçirme, bulgu, sorumlu, çözüm ve kapanış bilgileri LST.003 gerçek kayıtlarında tutulmalıdır."},

    "GP.3.1.1": {"pct": 90, "evidence": ["SRÇ.001", "SRÇ.XXX.Ş", "KLV.002", "KLV.003", "PRS.001"], "note": "Standart süreç; temel süreç öğelerini, yayılım bağlamını, uygulama rehberini ve uyarlama kılavuzlarını içermelidir. SRÇ.001 ve destek dokümanları bu yapıyı güçlü biçimde sağlar.", "action": "-"},
    "GP.3.1.2": {"pct": 85, "evidence": ["LST.007 (SRÇ.001)", "SRÇ.001 süreç akışı ve etkileşimler bölümü"], "note": "Standart, süreç sırası ve diğer süreçlerle etkileşimin bütünleşik sistem olarak belirlenmesini ister. Akış ve etkileşim matrisi mevcuttur.", "action": "-"},
    "GP.3.1.3": {"pct": 75, "evidence": ["LST.010 (SRÇ.001)", "SRÇ.001 roller bölümü"], "note": "Standart, standart süreci yürütecek rolleri ve yetkinlikleri ister. Roller/RACI tanımlıdır; yetkinliklerin rol bazında ayrıntılı tanımı sınırlıdır.", "action": "-"},
    "GP.3.1.4": {"pct": 70, "evidence": ["KLV.004", "LST.011", "Confluence/repository yapısı", "SRÇ.022"], "note": "Standart, tesis, araç, ağ, yöntem ve çalışma ortamı gereksinimlerini ister. Dokümantasyon altyapısı ve repository yapısı tanımlıdır; çalışma ortamı gereksinimleri kısmen dolaylıdır.", "action": "-"},
    "GP.3.1.5": {"pct": 55, "evidence": ["LST.009 (SRÇ.001)", "SRÇ.001 altındaki FRM.001", "91 - İç Denetimler"], "note": "Standart, etkinlik/uygunluk izleme yöntemleri, kriter/veri, süreç karakteristikleri, iç denetim ve yönetim gözden geçirme ihtiyacı ile süreç değişikliklerini ister. Yöntemler tanımlı; gerçekleşen veri, iç denetim ve yönetim gözden geçirme kanıtı sınırlıdır.", "action": "LST.009 ölçüm sonuçları dönemsel işlenmeli; iç denetim ve yönetim gözden geçirme kayıtlarıyla süreç değişikliği kararları ilişkilendirilmelidir."},

    "GP.3.2.1": {"pct": 55, "evidence": ["SRÇ.001", "KLV.002", "KLV.003", "Soru Bankası Projesi / LST.005 (SB)"], "note": "Standart, tanımlı sürecin standart süreçten bağlama göre seçilip/uyarlanmasını ve uygunluğunun doğrulanmasını ister. Standart süreç ve uyarlama rehberi vardır; belirli kullanım bağlamında uygulanmış uyarlama ve uygunluk doğrulama kaydı sınırlıdır.", "action": "Soru Bankası Projesi için kullanılan SRÇ.001 uyarlamaları, gerekçeleri ve standart sürece uygunluk kontrolü kayıt altına alınmalıdır."},
    "GP.3.2.2": {"pct": 60, "evidence": ["LST.010 (SRÇ.001)", "SRÇ.001 roller bölümü", "LST.012.Ş"], "note": "Standart, rollerin, sorumlulukların ve yetkilerin atanmasını ve duyurulmasını ister. Atama/RACI vardır; fiili iletişim ve kabul kanıtı sınırlıdır.", "action": "Rol ve sorumlulukların ilgili kişilere duyurulduğunu gösteren LST.012 veya eşdeğer iletişim kaydı oluşturulmalıdır."},
    "GP.3.2.3": {"pct": 35, "evidence": ["LST.010 (SRÇ.001)", "SRÇ.020 - Eğitim Süreci"], "note": "Standart, atanmış personel için uygun yetkinliklerin belirlenmesini ve süreci uygulayanlara uygun eğitimin sunulmasını ister. Rol tanımları vardır; SRÇ.001'e özel yetkinlik matrisi, eğitim planı ve eğitim kayıtları bulunmamaktadır.", "action": "SRÇ.001 rollerine gerekli yetkinlikler tanımlanmalı; ilgili personele eğitim/bilgilendirme verilmeli ve kayıtları tutulmalıdır."},
    "GP.3.2.4": {"pct": 60, "evidence": ["Confluence doküman alanı", "PRS.001", "LST.010", "LST.011"], "note": "Standart, gerekli insan kaynağı ve bilginin sağlanmasını, tahsis edilmesini ve kullanılmasını ister. Bilgi ve araçlar erişilebilirdir; insan kaynağı tahsis/kullanım kanıtları formal değildir.", "action": "Süreç için gerekli insan kaynağı ve bilgi kaynaklarının tahsisi ile fiili kullanım durumu kayıt altına alınmalıdır."},
    "GP.3.2.5": {"pct": 70, "evidence": ["Confluence/repository yapısı", "KLV.004", "LST.011", "SRÇ.022"], "note": "Standart, gerekli altyapı ve çalışma ortamının mevcut, desteklenen, kullanılan ve sürdürülen olmasını ister. Ortam mevcuttur ve kullanılmaktadır; bakım desteği kanıtı sınırlı olsa da temel beklenti karşılanmaktadır.", "action": "-"},
    "GP.3.2.6": {"pct": 40, "evidence": ["LST.009 (SRÇ.001)", "SRÇ.001 değerlendirme kayıtları"], "note": "Standart, davranış/uygunluk/etkinliği anlamak için verinin belirlenmesini, toplanmasını, analiz edilmesini ve sonuçların sürekli iyileştirmede kullanılmasını ister. Ölçüler tanımlıdır; gerçekleşen veri, analiz ve iyileştirme geri beslemesi henüz yeterli değildir.", "action": "LST.009 ölçümleri için gerçekleşen veriler toplanmalı, analiz edilmeli ve iyileştirme kararlarına bağlanmalıdır."},
}
...
def main() -> None:
    ...
    storage = storage.replace("FRM.001 - Süreç Gözden Geçirme Formu (SRÇ.001)", TARGET_TITLE)
