...
def build_storage() -> str:
    ...
    parts.append(table(["Alan", "Değer"], [
        ...
        ["Güncelleme Sıklığı", "Yılda bir kez, süreç hedefleri değiştiğinde veya ölçüm yaklaşımı güncellendiğinde"],
    ]))

    parts.append("<h3>0.2. Listenin Kullanım Amacı</h3>")
    parts.append(p("Bu liste, bir sürecin performansını izlemek için kullanılacak ölçümlerin; amaç, hesaplama yöntemi, veri kaynağı, hedef/eşik, izleme sıklığı, sorumlu rol ve ilgili BP/GP bağlantılarıyla birlikte tanımlanması için kullanılır."))
    parts.append(p("Liste, süreç tanımı dokümanındaki ölçüm ve izleme açıklamasını tekrar etmez; sürece özel performans ölçüm setini tek yerde yönetir."))
    ...
    parts.append(table(["Değer", "Anlamı"], [
        ["Ölçüm ID", "Sürece özel tekil ölçüm kimliği. Önerilen format: SRÇ.XXX-Ö01, SRÇ.XXX-Ö02."],
    ...
    parts.append(table([
        ...
        [placeholder("SRÇ.XXX-Ö01"), placeholder("Ölçüm adı"), placeholder("Neden ölçülür?"), placeholder("Nasıl hesaplanır veya değerlendirilir?"), placeholder("Kayıt / sistem / liste"), placeholder("Aylık / Sprint / Gözden geçirme dönemi"), placeholder("Hedef / eşik"), placeholder("Rol"), placeholder("BP / GP"), placeholder("Aktif / Askıda / Kapsam Dışı")],
        [placeholder("SRÇ.XXX-Ö02"), placeholder("Ölçüm adı"), placeholder("Neden ölçülür?"), placeholder("Nasıl hesaplanır veya değerlendirilir?"), placeholder("Kayıt / sistem / liste"), placeholder("Aylık / Sprint / Gözden geçirme dönemi"), placeholder("Hedef / eşik"), placeholder("Rol"), placeholder("BP / GP"), placeholder("Aktif / Askıda / Kapsam Dışı")],
    ]))
    ...
    parts.append(table([
        ...
        [placeholder("SRÇ.XXX-Ö01"), placeholder("Toplanacak veri"), placeholder("Kayıt / sistem / liste"), placeholder("Manuel / otomatik / gözden geçirme"), placeholder("Formül veya değerlendirme yöntemi"), placeholder("Rol"), placeholder("Kanıt kaydı")],
        [placeholder("SRÇ.XXX-Ö02"), placeholder("Toplanacak veri"), placeholder("Kayıt / sistem / liste"), placeholder("Manuel / otomatik / gözden geçirme"), placeholder("Formül veya değerlendirme yöntemi"), placeholder("Rol"), placeholder("Kanıt kaydı")],
    ]))
    ...
    parts.append(table([
        ...
        [placeholder("SRÇ.XXX-Ö01"), placeholder("Hedef / eşik"), placeholder("Periyot"), placeholder("Toplantı / rapor / form"), placeholder("Uygun / Sapma / İzleniyor"), placeholder("Sapmada yapılacak aksiyon"), placeholder("Not")],
        [placeholder("SRÇ.XXX-Ö02"), placeholder("Hedef / eşik"), placeholder("Periyot"), placeholder("Toplantı / rapor / form"), placeholder("Uygun / Sapma / İzleniyor"), placeholder("Sapmada yapılacak aksiyon"), placeholder("Not")],
    ]))
