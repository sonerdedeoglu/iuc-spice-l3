#!/usr/bin/env python3
"""Create a local draft candidate for İÜC.BİDB.LST.008.Ş template.
...
TITLE = "TASLAK - İÜC.BİDB.LST.008.Ş - İş Ürünleri ve Kalite Kriterleri Listesi Şablonu"
SLUG = "taslak-iuc-bidb-lst-008-s-is-urunleri-ve-kalite-kriterleri-listesi-sablonu"
...
def build_storage() -> str:
    ...
    parts.append("<blockquote>İÜC.BİDB.LST.008 - İş Ürünleri ve Kalite Kriterleri Listesi (İÜC.BİDB.SRÇ.XXX)</blockquote>")
...
def update_index() -> None:
    ...
    if existing:
        ...
        for i, p in enumerate(pages):
            if p.get("relative_path") == "pages/000-root-iuc-bidb-spice-2026-level-3/02-sablonlar/iuc-bidb-lst-008-s-is-urunleri-ve-kalite-kriterleri-listesi-sablonu":
                insert_at = i + 1
                break
